  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{
        __html: `
          @media print {
            /* Reserve space at the bottom of every page for the fixed FI footer. */
            @page { margin: 0.75in 0.65in 1in; size: letter; }
            ...
            /* Per-page Frontier Intelligence footer (Chromium/WebKit repeat
               position:fixed across printed pages). */
            .fi-print-footer {
          ...
          /* Hidden on screen — only shows in print. */
          @media screen {
            .fi-print-footer { display: none; }
          }
      ...
      {result && !loading && (
        <div className="snapshot-print-wrapper">
          ...
          {/* Fixed per-page footer — prints on every page via position:fixed
              inside @media print. Hidden on screen. */}
          <div className="fi-print-footer">
